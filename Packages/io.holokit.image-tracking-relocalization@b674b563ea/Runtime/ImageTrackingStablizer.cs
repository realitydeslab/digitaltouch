...
namespace HoloKit.ImageTrackingRelocalization
{
    ...
    public class ImageTrackingStablizer : MonoBehaviour
    {
        ...
        private float m_LastImageTrackedTime;
        ...
        private void OnTrackedImagesChanged(ARTrackedImagesChangedEventArgs args)
        {
            ...
            {
                Debug.Log($"[ImageTrackingStablizer] OnTrackedImagesChanged updated {Time.time - m_LastImageTrackedTime}");
                m_LastImageTrackedTime = Time.time;
